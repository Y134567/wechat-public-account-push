export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx08d8e9804bdcce89",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "2c59b4a2cae771bfba62106447229ce8",
  ...
  USERS: [
    {
      ...
      id: "R9p1JrJTVK_2aKILsUTdo7R2r7Nf_ZdkJcnbK5oDDGc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "R9p1JrJTVK_2aKILsUTdo7R2r7Nf_ZdkJcnbK5oDDGc",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "深圳",
  ...
  CALLBACK_TEMPLATE_ID: "R9p1JrJTVK_2aKILsUTdo7R2r7Nf_ZdkJcnbK5oDDGc",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oCa0L6-1Ybe9PrX1c5iFo_V08lBs",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
